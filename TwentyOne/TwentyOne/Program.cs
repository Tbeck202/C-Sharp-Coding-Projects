    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            while (!validAnswer)
            {
                ...
                if (!validAnswer) Console.WriteLine("Please only enter numeric values, no decimals.");
            }
            ...
            if (answer == "yes" || answer == "yeah" || answer == "y" || answer == "ya" || answer == "yep")
            {
                ...
                using (StreamWriter file = new StreamWriter(@"C:\Users\Tyler\Logs\log.txt", true))
                {
            ...
            Console.WriteLine("Thanks for stopping by.  Bye for now!");
            Console.Read();
        }
